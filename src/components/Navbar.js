...
import { Button, SwipeableDrawer, List, ListItem, ListItemIcon, ListItemText, Divider } from '@material-ui/core';
import { Menu, ExitToApp, AccountCircle, Publish, Home, Whatshot, Subscriptions } from '@material-ui/icons';
			...
			<div className="nav-left">
				...
				<Link to="/" className="paddingL20">
					<svg
						...
						style={{ pointerEvents: 'none', display: 'block', width: '80px', height: '24px' }}
					>
						<g
							viewBox="0 0 200 60"
							preserveAspectRatio="xMidYMid meet"
